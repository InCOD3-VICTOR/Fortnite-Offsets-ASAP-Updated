...
Engine::SkinnedMeshComponent::CachedWorldSpaceBounds = 0x5F8; //   0X1D9
...
FortniteGame::FortItemDefinition::Tier = 0x54; //0x15C
...
FortniteGame::FortBaseWeaponStats::ReloadScale = 0x100; //0xF9D
...
FortniteGame::FortRangedWeaponStats::SpreadDownsights = 0x160; //0x69d
